 ...
 **📌 Примечание по годам:**
- Если последний год (например, 2025) отображается некорректно или отсутствуют данные — уменьшите значение года до предыдущего (например, 2024)
- Данные за текущий год добавляются в базу World Bank постепенно и становятся полными к середине следующего года
        """,
        "about_text": """
...
INDICATORS_RU = {
    ...
    "EG.USE.COMM.GD.PP.KD": "⚡ Энергопотребление на душу (кг нефти)",
...
INDICATORS_EN = {
    ...
    "EN.ATM.CO2E.PC": "🌍 CO2 emissions (metric tons per capita (kg oil) ",
